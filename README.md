...
Мне нравится решать сложные задачи, строить процессы тестирования с нуля, если на проекте нет документации.  

Меня захватывает процесс тестирования и возможность отдать пользователю удобный и полезные продукт без дефектов.

Ежедневно практикуюсь в автотестах, могу создать простого телеграмм бота. Например, который будет генерить данные для тестирования граничных значений. Изучаю алгоритмы и фреймворки (Pyhton 3, Selenium).

Открыт к предложениям на позицию Qa engeener (тестировщик). Если у вас есть вакансия, которая соответствует моим навыкам и опыту, не стесняйтесь связаться со мной — буду рад сотрудничеству 🙌

🎯 **Мои цели**:

- Исчерпывающие тестирование не возможно, но к этому стоит стремиться;
