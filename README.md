...
Ежедневно практикуюсь в автотестах, могу создать простого телеграмм бота. Например, который будет генерить данные для тестирования граничных значений. Изучаю алгоритмы и фреймворки (Pyhton 3, Selenium, Cypress).
